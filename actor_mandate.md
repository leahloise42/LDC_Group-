...
|---|---|
| **Actor** | LDC: bloc 2|
| **Welfare function chosen** | Sufficitarian |
| **Why this function fits your mandate** |  LDCs tend to be lower income and more climate-vulnerable. Sufficitarian welfare function benefits the worst-off.
|
| **Key region(s)** | rsas, rsaf |
